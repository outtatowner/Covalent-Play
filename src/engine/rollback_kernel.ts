...
export class CovalentRollbackSieve {
  ...
  public recordTick(
    ...
    const frame: RollbackFrame = {
      ...
      human_pos_4d: [floatToQ16(human.x), floatToQ16(human.y), floatToQ16(human.z || 0), floatToQ16(human.w || 0)],
      be_pos_4d: [floatToQ16(be.x), floatToQ16(be.y), floatToQ16(be.z || 0), floatToQ16(be.w || 0)],
      human_rot_3d: [floatToQ16(human.pitch), floatToQ16(human.yaw), floatToQ16(human.roll)],
      human_rotor_4d: human.rotor ? [...human.rotor] as any : [0, 0, 0, 0, 0, 0],
